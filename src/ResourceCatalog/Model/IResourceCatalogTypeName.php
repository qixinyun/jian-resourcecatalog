...
IResourceCatalog::TYPE['DLYGJGXX'] => '��·�˹ܻ�����Ϣ',
IResourceCatalog::TYPE['DLYSJYZCFXX'] => '��·���侭Ӫ�ߴ�����Ϣ',
IResourceCatalog::TYPE['DLYSQYRYXX'] => '��·������ҵ������Ϣ',
IResourceCatalog::TYPE['GLJSSCQYXX'] => '��·�����г���ҵ��Ϣ',
IResourceCatalog::TYPE['JYXDLKYYSJSYHMD'] => '��Ӫ�Ե�·���������ʻԱ������',
IResourceCatalog::TYPE['SLJSSCQYXX'] => 'ˮ·�����г���ҵ��Ϣ',
IResourceCatalog::TYPE['SLYGJGXX'] => 'ˮ·�˹ܻ�����Ϣ',
IResourceCatalog::TYPE['SLYSQYRYXX'] => 'ˮ·������ҵ������Ϣ',
IResourceCatalog::TYPE['YYCLXXFR'] => 'Ӫ�˳�����Ϣ(����)',
IResourceCatalog::TYPE['YYCLXXZRR'] => 'Ӫ�˳�����Ϣ(��Ȼ��)',
IResourceCatalog::TYPE['YYCPXXFR'] => 'Ӫ�˴�����Ϣ(����)',
IResourceCatalog::TYPE['YYCPXXZRR'] => 'Ӫ�˴�����Ϣ(��Ȼ��)',
IResourceCatalog::TYPE['ZYCYZGXX'] => 'ְҵ��ҵ�ʸ���Ϣ',
        //@position
    );
}
