...
'ZRRYSTQFXX'=>164,
    ...
    const USERGROUP_TYPE_RELATIONSHIP = array(
        ...
        IUserGroup::ID['SFGW'] => array(self::TYPE['ZRRYSTQFXX'],self::TYPE['ZRRYSJFXX'],self::TYPE['ZRRYQTQFXX'],self::TYPE['ZRRYQJFXX'],self::TYPE['ZRRYDTQFXX'],self::TYPE['ZRRYDJFXX'],self::TYPE['FRYSTQFXX'],self::TYPE['FRYSJFXX'],self::TYPE['FRYQTQFXX'],self::TYPE['FRYQJFXX'],self::TYPE['FRYDTQFXX'],self::TYPE['FRYDJFXX'],self::TYPE['CCWLYQXX'],self::TYPE['CCWLJJLXX'],self::TYPE['RYBZXX'],self::TYPE['FRTQGYSYFXX'],self::TYPE['FRQSXX'],self::TYPE['FRNSXX'],self::TYPE['FRHONGMD'],self::TYPE['FRHEIMD'],self::TYPE['FRGYSYJFXX'],self::TYPE['GJJJCXX'],self::TYPE['ZRRTQGYSYFXX'],self::TYPE['ZRRGYSYJFXX'],self::TYPE['RYJLXX'],self::TYPE['QSXX'],self::TYPE['NSXX'],self::TYPE['GJJGRJCXX'],self::TYPE['GJJGRDKXX'],self::TYPE['DFXYF'],self::TYPE['DFXRMDXX'],self::TYPE['DFXBMDXX'],
            self::TYPE['LHJLFRHMD'],
            self::TYPE['LHCJFRHMD'],
            self::TYPE['JGJCDXZJL'],
            self::TYPE['SJJXMXX'],
        ...
        IUserGroup::ID['SSCJDGLJ'] => array(self::TYPE['P_FDDBR'],
            self::TYPE['QYJBXX'],
            self::TYPE['QYYCMLXX'],
            self::TYPE['SXQYHMD'],
            self::TYPE['GTGSHXX'],
        ...
        IUserGroup::ID['SSWJ'] => array(self::TYPE['C_DSSWDJXX'],
            self::TYPE['C_AJNSR'],
            self::TYPE['C_AJASRMD'],
            self::TYPE['QYGSZXXX'],
            self::TYPE['AJNSRXX'],
        ...
        IUserGroup::ID['SJYJ'] => array(self::TYPE['P_SJYJT_XSXJXX'],
            self::TYPE['JSZGXX'],
            self::TYPE['SJYXXS'],
            self::TYPE['JYJGXINXI'],
            self::TYPE['GRRYXXJYJ'],
        ...
        IUserGroup::ID['SMZJ'] => array(self::TYPE['P_GRDBJFF_INFO'],
