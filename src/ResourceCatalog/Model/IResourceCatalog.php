...
interface IResourceCatalog extends IResourceCatalogTypeName, IResourceCatalogTypeIdentify, IResourceCatalogTypeEnName, IResourceCatalogTypeDoublePublicity, IResourceCatalogTypeRedBlackList, IResourceCatalogIsConfirm
{
    ...
    const USERGROUP_TYPE_RELATIONSHIP = array(
        ...
        IUserGroup::ID['SYLBZJ'] => array(
            self::TYPE['JASYBJYBKXX'],
            self::TYPE['JASYBJYBCBRYXX'],
            self::TYPE['JASYBJYBCBJTXX'],
            self::TYPE['JASGRZHXX'],
            self::TYPE['JASGRCBXX'],
            self::TYPE['DFXBMDXX'],
            self::TYPE['FRHEIMD']
        ...
        IUserGroup::ID['AFXFL'] => array(),
        IUserGroup::ID['AFXGSL'] => array(),
        IUserGroup::ID['AFXTXW'] => array(),
        IUserGroup::ID['AFXZGH'] => array(),
        IUserGroup::ID['AFXYDGS'] => array(),
        IUserGroup::ID['AFXLTGS'] => array(),
        IUserGroup::ID['AFXDXGS'] => array(),
        IUserGroup::ID['AFXRMYH'] => array(),
        IUserGroup::ID['SYZGLJ'] => array(),
        IUserGroup::ID['SWTZB'] => array(),
        IUserGroup::ID['XJXSWGS'] => array(
            self::TYPE['SFXX']
        ),
        //@position_usergroup
    );
